...
import type { FilterOptions } from '~/components/SchoolsFilter.tsx'
import type { SchoolItem } from '~/components/SchoolsList.tsx'
...
export const Route = createFileRoute('/FindSchools')({
